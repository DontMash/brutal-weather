...
<button
	class={`${colorVariations[color]} hover:bold-shadow focus-visible:bold-shadow relative h-10 w-10 rounded-lg bg-neutral-800 fill-slate-100 p-1 transition after:absolute after:left-0 after:top-0 after:hidden after:h-[calc(100%_+_0.25rem)] after:w-[calc(100%_+_0.25rem)] after:rounded-[inherit] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:fill-neutral-800 hover:after:block focus:outline-none focus-visible:-translate-x-0.5 focus-visible:-translate-y-0.5 focus-visible:fill-neutral-800`}
	aria-label={name}
