...
<div
  class="flex w-full grow flex-col items-center justify-center space-y-2 p-2 text-center"
>
  <strong
    class={`${
  ...
  <time class="text-lg leading-none" datetime={forecastDateString}
    >{forecastDateString}</time
  >
</div>
