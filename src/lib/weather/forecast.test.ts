...
import { WeatherStatus, getWeatherStatus, type WeatherCode, getTemperatureStatus, getWinddirectionTitle } from './forecast';

describe('Forecast-Utils', () => {
    describe('getWeatherStatus', () => {
        const WEATHER_CODES: Array<WeatherCode> = [0, 1, 2, 3, 45, 48, 51, 53, 55, 56, 57, 61, 63, 65, 66, 67, 71, 73, 75, 77, 80, 81, 82, 85, 86, 95, 96, 99];
    ...
    describe('getTemperatureStatus', () => {
        ...
        const test = (value: number) => value <= COLD_TEMPERATURE_CELSIUS ? 'cold' : value >= HOT_TEMPERATURE_CELSIUS ? 'hot' : 'normal';
